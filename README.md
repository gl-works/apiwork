# apiwork OpenAPI Specification
[![Build Status](https://travis-ci.com/gl-works/apiwork.svg?branch=master)](https://travis-ci.com/gl-works/apiwork)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://gl-works.github.io/apiwork/)
- OpenAPI Raw Files: [JSON](https://gl-works.github.io/apiwork/openapi.json) [YAML](https://gl-works.github.io/apiwork/openapi.yaml)
